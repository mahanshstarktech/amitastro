        ...
        >
          <div>
            ...
            <p style={{ color: '#6E6E73', fontSize: 14, maxWidth: 460 }}>
              Receive thoughtful Vedic transit updates, Ekadashi alerts, and Vastu adjustments directly from Amit. No noise, strictly spiritual wisdom.
            </p>
          </div>
        ...
        >
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8, fontSize: 13.5, color: '#6E6E73' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                <Mail size={14} color="#3A3A6E" /> consultations@amitastro.com
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: 10, fontSize: 13.5 }}>
              <li><span onClick={() => onNavigate('/')} style={{ color: '#6E6E73', cursor: 'pointer' }}>{t('nav.home', 'Home')}</span></li>
