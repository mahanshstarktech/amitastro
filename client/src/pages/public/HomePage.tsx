...
export const HomePage: React.FC<HomePageProps> = ({
  ...
  const packagesShelfRef = useRef<HTMLDivElement>(null);
  ...
  const scrollPackagesShelf = (direction: 'left' | 'right') => {
    if (packagesShelfRef.current) {
      const scrollAmount = direction === 'left' ? -340 : 340;
      packagesShelfRef.current.scrollBy({ left: scrollAmount, behavior: 'smooth' });
    }
  };
        ...
        <div className="container" style={{ textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: 14, marginBottom: 48 }}>
            ...
            <button
              ...
              className="apple-btn-secondary hero-articles-cta"
          ...
          {/* Amit Hero Profile Card - Clean & Appealing */}
            ...
            <div className="hero-profile-info">
              ...
              <div className="hero-profile-details">
                <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                  ...
                  <span style={{ fontSize: 11, fontWeight: 700, backgroundColor: 'rgba(58, 58, 110, 0.08)', color: '#3A3A6E', padding: '2px 7px', borderRadius: 9999 }}>
                    Verified
                  </span>
                </div>
                ...
                <div className="hero-profile-stars">
                  <Star size={13} color="#C9A24B" fill="#C9A24B" />
                  <span style={{ fontSize: 12.5, fontWeight: 600, color: '#1D1D1F' }}>4.9/5</span>
                  <span style={{ fontSize: 12, color: '#86868B' }}>(1,000+ Consultations)</span>
                </div>
              </div>
            </div>
      ...
      <section className="section-padding">
        <div className="container">
          <div className="apple-shelf-header-wrap" style={{ marginBottom: 36 }}>
            ...
            {/* Scroll controls for mobile and tablet */}
            <div className="apple-shelf-ctrls packages-mobile-wrap">
              <button
                onClick={() => scrollPackagesShelf('left')}
                className="apple-shelf-btn"
              ...
              <button
                onClick={() => scrollPackagesShelf('right')}
                className="apple-shelf-btn"
          ...
          {/* Desktop View: Fixed 3-Column Grid (Not Scrollable) */}
          <div className="packages-desktop-wrap">
            <div className="packages-desktop-grid">
              {/* Quick Consult */}
              <div className="apple-card" style={{ padding: '32px 24px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                <div>
                  ...
                  <div style={{ fontSize: 12.5, color: '#6E6E73', marginBottom: 6 }}>
                  ...
                  <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: 10, fontSize: 13.5, marginBottom: 24 }}>
                    ...
                    <li style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                      <Check size={16} color="#2FA84F" /> Instant slot confirmation
                    </li>
                  </ul>
                </div>
              ...
              <div
                className="apple-card apple-package-popular"
                style={{
                  padding: '38px 28px',
                  display: 'flex',
              ...
              >
                <div>
                  ...
                  <div style={{ fontSize: 12.5, color: '#2FA84F', fontWeight: 600, marginBottom: 6 }}>
                    {countryInfo.prices.premium.costPerMin}
                  </div>
                  <div style={{ fontSize: 12, color: '#6E6E73', marginBottom: 20 }}>
          ...
          {/* Mobile & Tablet View: Apple-Style Swipeable Shelf */}
          <div className="packages-mobile-wrap">
            <div className="packages-mobile-shelf-container">
              <div ref={packagesShelfRef} className="apple-packages-shelf">
                {/* Quick Consult Shelf Card */}
                <div className="apple-package-card">
                  <div>
                    <div style={{ fontSize: 12.5, fontWeight: 600, color: '#86868B', textTransform: 'uppercase' }}>
                      Quick Answer
                    </div>
                    <h3 style={{ fontSize: 21, fontWeight: 700, margin: '6px 0 10px' }}>
                      Quick Consult
                    </h3>
                    <div style={{ fontSize: 30, fontWeight: 700, color: '#1D1D1F', marginBottom: 4 }}>
                      {countryInfo.prices.quick.formatted}
                    </div>
                    <div style={{ fontSize: 12, color: '#6E6E73', marginBottom: 4 }}>
                      {countryInfo.prices.quick.label}
                    </div>
                    <div style={{ fontSize: 11.5, color: '#86868B', marginBottom: 18 }}>
                      Cost/Min: <strong>{countryInfo.prices.quick.costPerMin}</strong>
                    </div>

                    <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: 10, fontSize: 13, marginBottom: 20 }}>
                      <li style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                        <Check size={15} color="#2FA84F" /> One specific query analyzed
                      </li>
                      <li style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                        <Check size={15} color="#2FA84F" /> Direct phone call with Amit
                      </li>
                      <li style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                        <Check size={15} color="#2FA84F" /> Instant slot confirmation
                      </li>
                    </ul>
                  </div>
                ...
                <div className="apple-package-card">
                  <div>
                    ...
                    <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: 10, fontSize: 13, marginBottom: 20 }}>
                      <li style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                        <Check size={15} color="#2FA84F" /> Kundli & Dasha breakdown
                      </li>
                      <li style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                        <Check size={15} color="#2FA84F" /> 3-Day follow-up in-app chat
                      </li>
                      <li style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                        <Check size={15} color="#2FA84F" /> Core astrological remedies
                      </li>
                    </ul>
                  </div>
                ...
                {/* Premium Consult Shelf Card */}
                <div className="apple-package-card apple-package-popular">
                  <div
                    style={{
                      position: 'absolute',
                      top: -10,
                  ...
                  <div>
                    <div style={{ fontSize: 12.5, fontWeight: 600, color: '#8E6A1C', textTransform: 'uppercase' }}>
                      Complete Guidance
                    </div>
                    <h3 style={{ fontSize: 22, fontWeight: 700, margin: '6px 0 10px' }}>
                      Premium Deep Consult
                    ...
                    <div style={{ fontSize: 12, color: '#2FA84F', fontWeight: 600, marginBottom: 4 }}>
                      {countryInfo.prices.premium.costPerMin}
                    </div>
                    <div style={{ fontSize: 11.5, color: '#6E6E73', marginBottom: 18 }}>
                      {countryInfo.prices.premium.label}
                    </div>

                    <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: 10, fontSize: 13, marginBottom: 20 }}>
                      <li style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                        <Check size={15} color="#2FA84F" /> <strong>45–60 min in-depth call</strong>
                      </li>
                      <li style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                        <Check size={15} color="#2FA84F" /> <strong>Written Remedies PDF</strong>
                      </li>
                      <li style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                        <Check size={15} color="#2FA84F" /> <strong>7-Day follow-up chat</strong>
                      </li>
                      <li style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                        <Check size={15} color="#2FA84F" /> Gemstone & Vastu tips
                      </li>
                    </ul>
                  </div>
